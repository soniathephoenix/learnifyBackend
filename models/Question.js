...
class Question {
  constructor({ question_id, level, points_required, question, clue, option_a, option_b, option_c, option_d, correct_answer }) { // G added clue
  ...
  static async getByPoints(points) {
    ...
    if (result.rows.length === 0) throw new Error("Question not found"); // G changed this line
